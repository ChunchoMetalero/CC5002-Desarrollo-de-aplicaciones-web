...
def validate_pedido(nombre_comprador, email, celular, region_id, comuna_id, products, product_type):
    if not validate_nombre_productor(nombre_comprador):
        print("Nombre comprador")
        return False
    if not validate_email(email):
        print("Email")
        return False
