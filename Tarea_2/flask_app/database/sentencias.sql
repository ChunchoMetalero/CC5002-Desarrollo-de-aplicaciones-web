...
-- obtener las frutas del listado
SELECT id, nombre FROM tipo_verdura_fruta WHERE id <= 37 order by id

-- obtener las verduras del listado
SELECT id, nombre FROM tipo_verdura_fruta WHERE id > 37 order by id

-- obtener las regiones
SELECT id, nombre FROM region order by id

-- obtener las comunas de una región
SELECT id, nombre FROM comuna WHERE region_id=?
